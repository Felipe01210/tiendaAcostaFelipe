        ...
        <div class="row d-flex justify-content-center h-100">
            <div class="col-12 col-md-6 b-right container h-100">
                <form class="col-12 h-100" action="loginexe.jsp" method="post">
                    ...
                    <span>Nombre:</span>
                    <br>
                    <input class="w-75" type="text" placeholder="example" name="nombre" id="nombre">
                    <br>
                    <br>
                    <span>Password:</span>
                    <br>
                    <input class="w-75" type="password" name="password" id="password">
                    <br>
                    <br>
                    <button class="w-5 align-bottom" type="submit">CONFIRM</button>
                    <br>
                    <br>
                    <span>Create your account <a href="register">here</a></span>
                </form>
            </div>
